...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
	...
	<form class="bs-example bs-example-form"  action="DengluServlet"  method="post" role="form">
	...
	<div style=" width: 650px;position: relative; left:42%;">
	   <input type="submit"  class="btn btn-lg btn-primary" value="提交">
	   &nbsp;&nbsp;&nbsp;&nbsp;
	   <a href="zhuce.jsp">
	   <button type="button" class="btn btn-lg btn-primary">新用户注册</button>
	   </a>
	   </div>
</form>
     <br><br><br><br><br>
